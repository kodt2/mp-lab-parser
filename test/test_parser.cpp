...
TEST(Parser, can_div)
{
	Parser parser;
	float res1 = 5.0/19.0;
	ASSERT_EQ(parser.work("5/19"), res1);
}
...
{
	Parser parser;
	float res = parser.work("((23.5 * 4.8 + 5.9 - (13.5 / 2.1 - 9.6) * (4.5 + 18.3) / 3.2) - (2.4 * 9.7 + (16.3 - 7.5 / 3.1) * 8.2 / 2.6) + ((5.3 + 12.6 * 3.8) - (7.9 / 2.4 + 15.2) * (3.5 - 8.4) / 4.7)) / ((18.2 - 9.5 + (6.3 * 2.9 - 4.1 / 2.0) * 3.6) + (8.4 * 1.3 + 5.7 / 2.8 - (14.8 - 9.3) * 4.2 / 3.4) - ((12.1 + 4.5 * 2.2) / (9.6 - 3.1 + 5.4) * (8.3 / 4.6 - 1.8) * 3.2))");
	float res1 = ((23.5 * 4.8 + 5.9 - (13.5 / 2.1 - 9.6) * (4.5 + 18.3) / 3.2) - (2.4 * 9.7 + (16.3 - 7.5 / 3.1) * 8.2 / 2.6) + ((5.3 + 12.6 * 3.8) - (7.9 / 2.4 + 15.2) * (3.5 - 8.4) / 4.7)) / ((18.2 - 9.5 + (6.3 * 2.9 - 4.1 / 2.0) * 3.6) + (8.4 * 1.3 + 5.7 / 2.8 - (14.8 - 9.3) * 4.2 / 3.4) - ((12.1 + 4.5 * 2.2) / (9.6 - 3.1 + 5.4) * (8.3 / 4.6 - 1.8) * 3.2));
	ASSERT_NEAR(res, res1, 0.0001f);
}
